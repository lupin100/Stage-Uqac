...
<template>
    <div class="section-block">
        ...
        <v-progress-circular v-if="isLoadingEvents" indeterminate color="primary" class="mt-4" />

        <v-alert v-else-if="eventsError" type="error" variant="tonal" class="mt-4">
            {{ eventsError }}
        </v-alert>

        <div v-else class="events-list">
            <div v-for="event in latestEvents" :key="event.id" class="event-item">
                ...
                <div class="event-content">
                    ...
                    <router-link v-if="event.eventType?.toLowerCase() === 'séminaire'"
                        :to="{ name: 'seminaire', params: { id: event.id } }" class="event-title-link">
                        {{ event.title }}
                    </router-link>
                    ...
                    " :to="{ name: 'congres-et-atelier', params: { id: event.id } }" class="event-title-link">
                        {{ event.title }}
                    </router-link>
