...
const fetchEventDetail = async () => {
  try {
    ...
    errorMessage.value = "Impossible de charger les détails du congrès/atelier."
    console.error(error)
  } finally {
...
<template>
  <v-container class="py-10" max-width="900">
    <v-btn variant="text" color="primary" to="/congres-et-ateliers" class="mb-6 px-0">
      <v-icon start>mdi-arrow-left</v-icon> Retour aux congrès et ateliers
    </v-btn>
